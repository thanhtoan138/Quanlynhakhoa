						...
						<div class="col-xs-4">
							...
							<div class="col-xs-12 col-sm-9 ">
								<table id="simple-table"
									...
									<thead>
										<tr>
											<td colspan="2"><input form="filter" name="dateWork"
												type="date" value=""></td>
											<td><form id="filter" action="/doctor/MedicalRecord">
									...
									<tbody>
										<c:forEach items="${pantienList }" var="item">
											<tr>
												...
												<td class="center">
													<form action="/doctor/getMedicalRecord" method="POST">
						...
						<div class="col-xs-12 col-sm-6">
							<div class="widget-box">
								...
								<div class="widget-body">
									<form action="/doctor/updateMedicalRecord" method="post">
										<div class="widget-main">
											...
											<div class="form-group">
												...
												<div class='input-group'>
													<input type="datetime-local" min="" class="form-control"
											...
											<div class="form-group">
												<label for="exampleForm2">Bác Sĩ</label> <input
													type="hidden" name="doctorId"
													value="${appoSelete.doctor.id }"> <input
										...
										<input type="submit" title="Kết thúc">
									</form>
								</div>
							</div>
						</div>
...
<script type="text/javascript">
	document.getElementById("myLocalDate").min = 
	$(function() {
