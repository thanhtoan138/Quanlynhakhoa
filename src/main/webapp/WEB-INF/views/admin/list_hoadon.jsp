								...
								<tbody>
									<c:forEach items="${bills }" var="item">
										<tr>
											...
											<td>${item.medicalRecord.appointment.id }</td>
											<td>${item.medicalRecord.patient.userDetail.fullname }</td>
											<td>${item.medicalRecord.doctor.userDetail.fullname }</td>
											<td>${item.medicalRecord.examinationDate}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
